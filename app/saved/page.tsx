...
export const metadata: Metadata = {
  title: "Saved",
  description:
    "Your saved papers, tools, models, and jobs from across Signal & Noise — stored privately in your browser.",
};
    ...
    <div className="flex flex-col gap-8">
      <section className="pt-6">
        ...
        <p className="mt-3 max-w-2xl text-lg text-zinc-600 dark:text-zinc-400">
          Everything you&apos;ve bookmarked across the radar and interview pages,
